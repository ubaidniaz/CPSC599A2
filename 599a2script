...
def get_weather(latitude, longitude, ser):
    ...
    if response.status_code == 200:
        ...
        # Prepare the data string to send temperature and wind direction
        data_string = f"T{temperature} D{wind_direction}\n"
...
#         # Prepare the data string using abbreviations and spaces
#         data_string = f"E{elevation} T{temperature} W{wind_speed} D{wind_direction}\n"
